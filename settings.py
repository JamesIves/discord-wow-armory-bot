...
CREDENTIAL_ERROR = 'There was an error during token generation. \
  Either the Blizzard API was not reachable or your Blizzard API credentials are not correct. :fire:'
